...
class LoRALayer:
    ...
    def __init__(
        ...
        lora_alpha: int,
        lora_dropout: float,
        layer_type: str  # Add layer type to track what kind of layer this is
    ):
        self.r = r
        self.lora_alpha = lora_alpha
        self.layer_type = layer_type  # 'attention' or 'ffn'
        if lora_dropout > 0.:
...
class LoRAAdapter(nn.Module, LoRALayer):
    ...
    def __init__(
        ...
        layer_name: str,  # Add layer name for identification
        r: int = 0,
        lora_alpha: int = 1,
        lora_dropout: float = 0.,
        layer_type: str = 'attention'  # Default to attention type
    ):
...
class LoRAConfig:
    ...
    def __init__(
        ...
        # Default attention targets if none provided
